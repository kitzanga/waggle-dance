...
Inspired by Apple's desktop media apps (Music, TV, Photos, Games). See `.kiro/steering/design-system.md` for full token reference.

- **True black canvas** with layered depth through background progression
- **Apple-neutral cool grays** (#0d0d0d → #1a1a1c → #2c2c2e → #3a3a3c)
- **Warm amber accent** (#ff9f0a) — used sparingly for primary actions and active states
- **Sidebar navigation** — 240px fixed left panel, Apple Music/Photos pattern
- **SF Pro-style system font** for UI, New York/Georgia serif for reading
- **Pill-shaped buttons**, no-border inputs, 14px card radius
- **Content is the interface** — UI recedes, stories are the hero
- **Depth through layering** — surfaces stack with subtle separation, not borders
- **Motion with purpose** — 250ms default transitions, cubic-bezier(0.25, 0.1, 0.25, 1)

---

## The Reading Experience

The app is the storyteller, not just the display surface. Two modes available:

### Full-Bleed Immersive (default)

- True black background
- Stories revealed in paced chapters — not all at once
...
- Slightly lighter background (#0d0d0d)
- Font size increases to 20px
- Line length constrained to 65 characters
- All images hidden
- Pure reading — minimal, distraction-free typography
...
| AI Engine | Anthropic Claude (claude-sonnet-4-5, short alias) via streaming API routes |
...
- Stack: Next.js 16 + TypeScript, Supabase, Vercel, Anthropic API (claude-sonnet-4-5 short alias).
- Dark, cool, editorial aesthetic — Apple HIG-inspired (Music, TV, Photos, Games).
- Sidebar navigation pattern (Apple Music style, 240px fixed left panel).
- Intake is a focused single-panel conversation, not chat bubbles.
- Reading experience defaults to full-bleed immersive with option for text-focus mode.
- Mobile-first.
- The Waggle Dance metaphor should be treated as signal, direction, and shared understanding — not as a cute thematic layer.
- System prompts for intake and story engine are drafted and functional.
...
- Reader text-focus mode toggle (designed, not yet wired)
